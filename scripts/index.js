...
const popupClosedButton = document.querySelector('.popup_type_place .popup__closed');
popupClosedButton.addEventListener('click', onCloseClick);

function onNewCardFormSubmit(evt) {
	evt.preventDefault();
	const nameInput = document.querySelector('.popup_type_place .popup__input_type_name');
	const imageInput = document.querySelector('.popup_type_place .popup__input_type_link-url');
...
function openGallery(image, figcaption) {
	...
	const galleryFigcaption = document.querySelector('.popup_gallery .popup__figcaption');
	galleryFigcaption.innerText = figcaption;

	popupGallery.classList.add('popup_opened');
}

const popupGalleryCloseButton = document.querySelector('.popup_gallery .popup__closed');
